...
class HeavyVaisseau :public Vaisseau{

protected:
	int lifetime;
	float r, g, b, posX, posY;
public:
	HeavyVaisseau(float posX_ = 0.0, float posY_ = 0.0, float r_ = 0.0, float g_ = 0.0, float b_ = 0.0, int lifetime_ = 0, Missile *missile_ = nullptr) :
